...
//--------------------------------------------------------------------------
{
	...
	//	Random
	initSeed();//현재 시간을  최초 단한번 가져와 난수SEED에 반영한다
...
//상호 - 아래 3개의 메소드는 각각 랜덤변수 초기화, 랜덤연산, 랜덤호출
//--------------------------------------------------------------------------
void SUtil::initSeed()
//--------------------------------------------------------------------------
{//현재 시간을 가져와 반영한다 - 최초 한번만 실행한다
	m_Seed = (((int)SUTIL_GetTime()/1000) ^ 0x5DEECE66DL) & 0xffffffffL;
}
//--------------------------------------------------------------------------
int SUtil::nextInt()
//--------------------------------------------------------------------------
...
//--------------------------------------------------------------------------
{//난수 생성을 한다
	m_Seed = (m_Seed * 0x5DEECE66DL + 0xBL) & 0xffffffffL; 
