...
//--------------------------------------------------------------------------
{
	...
	else if(hero->_m_actNum == HERO_DOWNED_2 && hero->s_Status.LIFE<=0){//ÁÖÀÎ°ø »ç¸Á
		b_PopupUi = true;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if(hero->s_Skill_Set.act){
				if(hero->s_Skill_Set.act && hero->s_Skill_Set.Skill_ID[Character::s_Status.SEX][hero->s_Skill_Set.Num] == 11){//¿¹¿Ü½ºÅ³
...
// 			 						hero->s_Knife_Eff[4].LVup_Eff_Ins->m_bLoop = false;
 	 					...
 	 					case 8:
							...
							hero->s_Knife_Eff[0].LVup_Eff_Ins = GL_NEW ASpriteInstance(hero->_spr_Skill[hero->s_Status.SEX][hero->s_Skill_Set.Num], 100, 200, NULL);// 0¹øÂ° ¹è¿­, ½Ç»ç¿ë½Ã´Â define ÇÊ¿ä
	 					...
	 					case 11:
							...
							hero->s_Knife_Eff[1].LVup_Eff_Ins = GL_NEW ASpriteInstance(hero->_spr_Skill[hero->s_Status.SEX][hero->s_Skill_Set.Num], 100, 200, NULL);// 0¹øÂ° ¹è¿­, ½Ç»ç¿ë½Ã´Â define ÇÊ¿ä
 	 					...
 	 					case 14:
							...
							hero->s_Knife_Eff[2].LVup_Eff_Ins = GL_NEW ASpriteInstance(hero->_spr_Skill[hero->s_Status.SEX][hero->s_Skill_Set.Num], 100, 200, NULL);// 0¹øÂ° ¹è¿­, ½Ç»ç¿ë½Ã´Â define ÇÊ¿ä
