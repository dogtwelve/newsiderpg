...
#define IGP_WH_TITLE_Y (_sprIGPCataLogo->GetHeight() + IGP_LOGO_HEIGHT + 5)
#define IGP_WH_ICON_X (20)
#define IGP_WH_ICON_Y (IGP_WH_TITLE_Y+20)
#define IGP_WH_ICON_GAP_Y 20
#define IGP_WH_TEXT_X (IGP_WH_ICON_X+_sprWHImages[0]->GetWidth()+5)
#define IGP_WH_TEXT_WIDTH (65)

#define IGP_SELECT_REC_WIDTH (92)
