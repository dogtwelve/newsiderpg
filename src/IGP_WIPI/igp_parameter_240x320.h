...
#define IGP_WH_TITLE_Y (_sprIGPCataLogo->GetHeight() + IGP_LOGO_HEIGHT + 40)
...
#define IGP_SELECT_REC_WIDTH (200)
...
#define IGP_GAME_INTRO_Y SCREEN_SHOOT_Y+_sprIGPGame[0]->GetHeight()+15
